...
const iconSVGMap = {
  ...
  /** Icon by Iconic Pro (https://iconic.app/git-fork/) */
  program: (props: SVGProps): JSX.Element => (
    <svg {...props} width='24' height='24' viewBox='0 0 24 24' fill='none'>
  ...
  /** Icon by Iconic (https://iconic.app/floppy-disc/) */
  save: (props: SVGProps): JSX.Element => (
    <svg {...props} width='24' height='24' viewBox='0 0 24 24' fill='none'>
